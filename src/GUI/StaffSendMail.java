 ...
 * @author abhi
 */
public class StaffSendMail extends javax.swing.JFrame {

    /**
     * Creates new form StaffSendMail
     */
    String to;
    
    public StaffSendMail(String to, String theme) {
        this.to = to;
        initComponents();
        themeLoad(theme);
        jTextField2.setText(to);
    }
    public StaffSendMail() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField1.getText().equals("") && !jTextArea1.getText().equals("")) {
            ...
            if (jTextField2.getText().equals("All Users")) {

                ResultSet rs = search("SELECT * FROM staff WHERE status = '1'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffSendMail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffSendMail().setVisible(true);
            }
        });
    }
