...
public class AddCity extends javax.swing.JFrame {
    ...
    public AddCity(ManageTeacher mt, String theme) {
        this.mt = mt;
        initComponents();
        themeLoad(theme);
    }

    public AddCity(UpdateStudent us, String theme) {
        this.us = us;
        initComponents();
        themeLoad(theme);
    }

    public AddCity(AddStudent ms, String theme) {
        this.ms = ms;
        initComponents();
        themeLoad(theme);
    }

    public AddCity(ManageStaff s, String theme) {
        this.s = s;
        initComponents();
        themeLoad(theme);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ResultSet rs = search("SELECT COUNT(id) AS count FROM city WHERE city.city = '" + jTextField1.getText() + "';");

            if (rs.next()) {

                if (rs.getString("count").equals("0")) {
                    if (1 == iud("INSERT INTO `class_managment`.`city` (`city`) VALUES ('" + jTextField1.getText() + "');")) {
                        if (mt != null) {
                            this.mt.cityLoad();
                        ...
                        JOptionPane.showMessageDialog(this, "City added", "Success", JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
                    } else {
                        jTextField1.setText("");
                        JOptionPane.showMessageDialog(this, "Can not add this city now, please try again", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    jTextField1.setText("");
                    JOptionPane.showMessageDialog(this, "This city is already in system", "Warning", JOptionPane.WARNING_MESSAGE);
                }
