...
public class Teacher extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NAME", "NIC", "ADDRESS", "EMAIL", "CONTACT"
            }
        ) {
        ...
        jLabel4.setText("Search Teacher");
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        ResultSet rs = search("SELECT MAX(id) AS id FROM teacher;");
        ...
        ManageTeacher mt = new ManageTeacher(this, theme);
        mt.jTextField1.setText(id);
        mt.jButton2.setEnabled(false);
        mt.setVisible(true);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if (row != -1) {
            ...
            ManageTeacher mt = new ManageTeacher(this, jTable1.getValueAt(row, 0).toString(),theme);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (row != -1) {
            int r = JOptionPane.showConfirmDialog(this, "Are you sure do you want to delete this teacher", "Conform", JOptionPane.INFORMATION_MESSAGE);
            if (r == 0) {
                if (1 == iud("UPDATE teacher SET `status`='0' WHERE  `id`='" + jTable1.getValueAt(row, 0).toString() + "';")) {
                    tableLoad();
                    JOptionPane.showMessageDialog(this, "Deleted", "Success", JOptionPane.INFORMATION_MESSAGE);
                }else{
                    JOptionPane.showMessageDialog(this, "Can not delete this teacher now, Please try again later", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        if (row != -1) {
            int r = JOptionPane.showConfirmDialog(this, "Do you want to send email to "+jTable1.getValueAt(row, 1)+" teacher", "Conform", JOptionPane.INFORMATION_MESSAGE);
            
            if (r == 0) {
                new TeacherSendMail(jTable1.getValueAt(row, 4).toString(), theme).setVisible(true);
            }

        } else {
            int r = JOptionPane.showConfirmDialog(this, "Do you want to send email to all registerd teacher", "Conform", JOptionPane.INFORMATION_MESSAGE);
       
            if (r == 0) {
                new TeacherSendMail("All Teachers", theme).setVisible(true);
            }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
                            ...
                            try {
                                String path = "src//reports//teachers.jasper";
                                ...
                                map.put("Parameter6", "REGISTERD TEACHERS");
