...
public class Exam extends javax.swing.JInternalFrame {
    ...
    public Exam(String theme, String userId) {
        initComponents();
        this.theme = theme;
        this.userId = userId;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EXAM ID", "GRADE", "SUBJECT", "DESC", "DATE ", "START TIME", "END TIME", "STATUS"
            }
        ) {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/72,52,212/rescheduling_a_task_32px.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/exam_32px.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/test_passed_32px.png"))); // NOI18N
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if (row != -1) {
            ...
            ManageExam me = new ManageExam(this, theme);
            me.jTextField1.setText(jTable1.getValueAt(row, 0).toString());
            me.jComboBox2.setSelectedItem(jTable1.getValueAt(row, 1).toString());
            me.subjectLoad(me.jComboBox2.getSelectedItem().toString());
            me.jComboBox3.setSelectedItem(jTable1.getValueAt(row, 2).toString());
            me.jTextArea1.setText(jTable1.getValueAt(row, 3).toString());

            String sDate1 = jTable1.getValueAt(row, 4).toString();
            Date date1 = null;
            try {
            ...
            me.jDateChooser1.setDate(date1);

            DateFormat sdf = new SimpleDateFormat("hh:mm:ss");
            Date start = null;
            Date end = null;
            try {
                 start = sdf.parse(jTable1.getValueAt(row, 5).toString());
                 end = sdf.parse(jTable1.getValueAt(row, 6).toString());
            } catch (ParseException ex) {
                ex.printStackTrace();
                warning(ex);
            }

            me.jSpinner1.setValue(start);
            me.jSpinner2.setValue(end);
            me.jButton1.setEnabled(false);
            me.setVisible(true);

        } else {
            JOptionPane.showMessageDialog(this, "Please Select exam", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_jLabel1MouseClicked

    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked

        ResultSet rs = search("select CONCAT('EX-',MAX(CAST(SUBSTRING(id,4,8) AS UNSIGNED))) AS id from exam");
        ...
        ManageExam me = new ManageExam(this, theme);
        me.jButton2.setEnabled(false);
        me.jTextField1.setText(id);
        me.setVisible(true);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (row != -1) {
            int r = JOptionPane.showConfirmDialog(this, "Are you sure do you want to delete this exam details", "Conform", JOptionPane.INFORMATION_MESSAGE);
            if (r == 0) {
                if (1 == iud("UPDATE exam SET `status`='0' WHERE  `id`='" + jTable1.getValueAt(row, 0).toString() + "';")) {
                    JOptionPane.showMessageDialog(this, "Deleted", "Success", JOptionPane.INFORMATION_MESSAGE);
                    tableLoad();
                } else {
                    JOptionPane.showMessageDialog(this, "Can not delete this exam details now, Please try again later", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        if (row != -1) {
           new PostponeExam(this, theme, userId, jTable1.getValueAt(row, 0).toString()).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Please Select exam", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        new ManageExamResult(theme).setVisible(true);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        if (row != -1) {
            String exam  = jTable1.getValueAt(row, 1).toString()+" "+jTable1.getValueAt(row, 2).toString()+" "+jTable1.getValueAt(row, 3).toString();
            new ViewExamResults(theme, jTable1.getValueAt(row, 0).toString(),exam, jTable1.getValueAt(row, 4).toString()).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Please Select exam", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
         try {
            String path = "src//reports//exams.jasper";
            ...
            map.put("Parameter6", "INSTITUTE EXAMS");
    ...
    void tableLoad() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if(rs.getString("exam.status").equals("1")){
                    v.add("Pending");
                }else if(rs.getString("exam.status").equals("2")){
                    v.add("Postponed");
                }else if(rs.getString("exam.status").equals("3")){
                    v.add("Cancled");
                }else if(rs.getString("exam.status").equals("4")){
                    v.add("Finished");
                }
    ...
    void themeLoad(String theme){
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/"+theme+"/test_passed_32px.png")));
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/"+theme+"/exam_32px.png")));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/images/basic/"+theme+"/rescheduling_a_task_32px.png")));
